...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateUser = channel.unary_unary(
                ...
                request_serializer=user__pb2.UpdateUserMsg.SerializeToString,
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'UpdateUser': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateUser,
                    request_deserializer=user__pb2.UpdateUserMsg.FromString,
...
class UserService(object):
    ...
    def UpdateUser(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/user.UserService/UpdateUser',
            user__pb2.UpdateUserMsg.SerializeToString,
